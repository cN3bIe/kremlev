<div class="iziModal">
	<div class="wr-order-online">
		<a href="#close" class="ic close close-izi v1 min" data-izimodal-close="" data-izimodal-transitionout="bounceOutDown"></a>
		<div class="order-online">
			<div class="title-online">Вы добавили товар в корзину</div>
			<div class="bl-card current-card"></div>
			<div class="bl-btn">
				<button class="btn v1 continue-shopping" data-izimodal-close="" data-izimodal-transitionout="bounceOutDown">Продолжить покупки</button>
				<div class="total">
					<div class="bl-total">
						<div class="total-title">Итого:</div>
						<div class="price">0 руб.</div>
					</div>
					<a href="/order/" class="a-d btn">Оформить заказ</a>
				</div>
			</div>
			<div class="title-online title-another-card">Другие товары в корзине</div>
			...
			<div id="template" class="dn">
				<div class="item-card row">
					...
					<div class="bl-del-select row dn">
						<div class="bl-bookmark col s12 m6 ">
						...
						<a href="#" class="col s12 m6 del close v1"><div class="ic close v2"></div>Удалить<br>без сохранения</a>
					...
					<div class="card-info row">
						...
						<div class="col s12 m7 p0">
							...
							<div class="col s12 l6 bl-count p0">
								<button class="reduce-count bl-brick">-</button>
								<div class="count bl-brick"><input type="text" class="fi-d" value="1"></div>
								<button class="enlarge-count bl-brick">+</button>
							</div>
						</div>
