...
function custom_theme_options() {
	...
	$custom_settings = array(
		...
		'sections'        => array(
			array('id' => 'common', 'title' => 'Общие'),
			array('id' => 'header', 'title' => 'Шапка'),
		...
		'settings'        => array(
			...
			array(
				'id'          => 'main_phone',
				'label'       => 'Телефон',
				'desc'        => 'Главный телефон на странице',
				'std'         => '',
				'type'        => 'text',
				'section'     => 'common',
			),
			...
			array(
				...
				'desc'        => 'Выберите страницу закладок',
				'std'         => '',
				'type'        => 'page-select',
				'section'     => 'common',
				'rows'        => '',
			...
			array(
				'id'          => 'logo_upload',
				'label'       => 'Логотип',
				'desc'        => 'Загрузка картинки для логотипа сайта',
				'type'        => 'upload',
				'section'     => 'header'
				),
			array(
				'id'          => 'desc_on_off',
				'label'       => 'Включение описания сайта',
				'std'         => 'off',
				'type'        => 'on-off',
				'section'     => 'header'
				),
			...
			array(
				'id'          => 'baner_upload',
				'label'       => 'Банер',
				'desc'        => 'Загрузите картинку для банера новостей',
				'type'        => 'upload',
				'section'     => 'news'
			),
			array(
